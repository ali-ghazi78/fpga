/*****************************************************************************
* Filename:          D:\fpga_project\cpu\23/drivers/timer_v1_00_a/src/timer_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the timer driver
...
XStatus TIMER_SelfTest(void * baseaddr_p)
{
  ...
  TIMER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TIMER_mReadSlaveReg0(baseaddr, 0);
  ...
  TIMER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TIMER_mReadSlaveReg1(baseaddr, 0);
