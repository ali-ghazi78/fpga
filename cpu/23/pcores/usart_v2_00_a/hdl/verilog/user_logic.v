...
my_usart mm(
  ...
  always @( slv_reg_read_sel or slv_reg0 or slv_reg1 )
    begin: SLAVE_REG_READ_PROC
      ...
      cas( slv_reg_read_sel )
        2'b10 : slv_ip2bus_data <= slv_reg0;
        2'b01 : begin slv_reg1=slv_output_temp_signal;
						slv_ip2bus_data = slv_reg1;//yadet nare alamate => bardarin chon hich vaqt meghadare dorsot update nemishe 	
					end
