...
// Date:              Sat Aug 04 03:59:16 2018 (by Create and Import Peripheral Wizard)
...
my_usart mm(
  ...
  always @( slv_reg_read_sel or slv_reg0 or slv_output_temp_signal )
    begin: SLAVE_REG_READ_PROC

      case( slv_reg_read_sel )
        2'b10 : slv_ip2bus_data <= slv_reg0;
        2'b01 :  slv_ip2bus_data <= slv_output_temp_signal;//yadet nare alamate => bardarin chon hich vaqt meghadare dorsot update nemishe 	
        default : slv_ip2bus_data <= 0;
      endcase
		//slv_reg1<=slv_output_temp_signal;
