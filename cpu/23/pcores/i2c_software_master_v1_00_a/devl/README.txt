...
Peripheral Summary:
  ...
  logical library name                       : i2c_software_master_v1_00_a
  top name                                   : i2c_software_master
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- HDL source file(s)
  ...
  hdl/vhdl/i2c_software_master.vhd
...
- XPS interface file(s)
  ...
  data/i2c_software_master_v2_1_0.mpd
  ...
  data/i2c_software_master_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/i2c_software_master.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/i2c_software_master_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/i2c_software_master_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/i2c_software_master_v2_1_0.tcl
