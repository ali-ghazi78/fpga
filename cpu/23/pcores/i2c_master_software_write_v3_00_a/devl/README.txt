...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\fpga_project\cpu\23
  logical library name                       : i2c_master_software_write_v3_00_a
  top name                                   : i2c_master_software_write
  version                                    : 3.00.a
  type                                       : PLB (v4.6) slave
...
- HDL source file(s)
  ...
  hdl/vhdl/i2c_master_software_write.vhd
...
- XPS interface file(s)
  ...
  data/i2c_master_software_write_v2_1_0.mpd
  ...
  data/i2c_master_software_write_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/i2c_master_software_write.ise
  ...
  devl/projnav/i2c_master_software_write.cli

    This is the TCL command line file used to generate the .ise file.

- XST synthesis file(s)

  devl/synthesis/i2c_master_software_write_xst.scr
  ...
  devl/synthesis/i2c_master_software_write_xst.prj
...
- Driver source file(s)
  ...
  src/i2c_master_software_write.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/i2c_master_software_write_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/i2c_master_software_write_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	D:\fpga_project\cpu\23\F:\xilinx\embeded_development_kit\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
