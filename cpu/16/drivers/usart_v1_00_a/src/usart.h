/*****************************************************************************
* Filename:          D:\fpga_project\cpu\16/drivers/usart_v1_00_a/src/usart.h
* Version:           1.00.a
 ...
 */
#define USART_SOFT_RST_SPACE_OFFSET (0x00000100)
#define USART_RST_REG_OFFSET (USART_SOFT_RST_SPACE_OFFSET + 0x00000000)
 ...
 * @note
 * C-style signature:
 * 	void USART_mReset(Xuint32 BaseAddress)
 *
 */
#define USART_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(USART_RST_REG_OFFSET), SOFT_RESET)
