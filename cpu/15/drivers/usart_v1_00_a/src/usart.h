/*****************************************************************************
* Filename:          D:\fpga_project\cpu\15/drivers/usart_v1_00_a/src/usart.h
* Version:           1.00.a
...
#define USART_SLV_REG2_OFFSET (USART_USER_SLV_SPACE_OFFSET + 0x00000008)
#define USART_SLV_REG3_OFFSET (USART_USER_SLV_SPACE_OFFSET + 0x0000000C)
...
#define USART_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (USART_SLV_REG2_OFFSET) + (RegOffset), (Xuint32)(Value))
#define USART_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (USART_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define USART_mReadSlaveReg2(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (USART_SLV_REG2_OFFSET) + (RegOffset))
#define USART_mReadSlaveReg3(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (USART_SLV_REG3_OFFSET) + (RegOffset))
