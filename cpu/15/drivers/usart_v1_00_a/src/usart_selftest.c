/*****************************************************************************
* Filename:          D:\fpga_project\cpu\15/drivers/usart_v1_00_a/src/usart_selftest.c
* Version:           1.00.a
...
XStatus USART_SelfTest(void * baseaddr_p)
{
  ...
  USART_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = USART_mReadSlaveReg2(baseaddr, 0);
  ...
  USART_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = USART_mReadSlaveReg3(baseaddr, 0);
