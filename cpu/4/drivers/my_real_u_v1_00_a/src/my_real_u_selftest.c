/*****************************************************************************
* Filename:          D:\fpga_project\cpu\4/drivers/my_real_u_v1_00_a/src/my_real_u_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_real_u driver
...
XStatus MY_REAL_U_SelfTest(void * baseaddr_p)
{
  ...
  MY_REAL_U_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MY_REAL_U_mReadSlaveReg0(baseaddr, 0);
  ...
  MY_REAL_U_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MY_REAL_U_mReadSlaveReg1(baseaddr, 0);
  ...
  MY_REAL_U_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MY_REAL_U_mReadSlaveReg2(baseaddr, 0);
  ...
  MY_REAL_U_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MY_REAL_U_mReadSlaveReg3(baseaddr, 0);
