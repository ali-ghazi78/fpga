/*****************************************************************************
* Filename:          D:\fpga_project\cpu\10/drivers/pwm_peipheral_v1_00_a/src/pwm_peipheral_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the pwm_peipheral driver
...
XStatus PWM_PEIPHERAL_SelfTest(void * baseaddr_p)
{
  ...
  PWM_PEIPHERAL_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PWM_PEIPHERAL_mReadSlaveReg0(baseaddr, 0);
  ...
  PWM_PEIPHERAL_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PWM_PEIPHERAL_mReadSlaveReg1(baseaddr, 0);
  ...
  PWM_PEIPHERAL_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = PWM_PEIPHERAL_mReadSlaveReg2(baseaddr, 0);
  ...
  PWM_PEIPHERAL_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = PWM_PEIPHERAL_mReadSlaveReg3(baseaddr, 0);
