/*****************************************************************************
* Filename:          D:\fpga_project\cpu\5/drivers/uart_peripheral_v1_00_a/src/uart_peripheral_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the uart_peripheral driver
...
XStatus UART_PERIPHERAL_SelfTest(void * baseaddr_p)
{
  ...
  UART_PERIPHERAL_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = UART_PERIPHERAL_mReadSlaveReg0(baseaddr, 0);
  ...
  UART_PERIPHERAL_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = UART_PERIPHERAL_mReadSlaveReg1(baseaddr, 0);
  ...
  UART_PERIPHERAL_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = UART_PERIPHERAL_mReadSlaveReg2(baseaddr, 0);
  ...
  UART_PERIPHERAL_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = UART_PERIPHERAL_mReadSlaveReg3(baseaddr, 0);
  ...
  UART_PERIPHERAL_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = UART_PERIPHERAL_mReadSlaveReg4(baseaddr, 0);
