...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\fpga_project\cpu\5
  logical library name                       : uart_peripheral_v1_00_a
  top name                                   : uart_peripheral
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XPS interface file(s)
  ...
  data/uart_peripheral_v2_1_0.mpd
  ...
  data/uart_peripheral_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/uart_peripheral.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/uart_peripheral_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/uart_peripheral_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/uart_peripheral_v2_1_0.tcl
...
plbv46_slave_burst_v1_01_a
	D:\fpga_project\cpu\5\F:\xilinx\embeded_development_kit\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_burst_v1_01_a\doc\plbv46_slave_burst.pdf
