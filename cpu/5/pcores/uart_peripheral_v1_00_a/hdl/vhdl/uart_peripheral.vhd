------------------------------------------------------------------------------
-- uart_peripheral.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          uart_peripheral.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Wed Jul 18 21:30:45 2018 (by Create and Import Peripheral Wizard)
...
entity uart_peripheral is
  ...
  (
    ...
    --USER ports added here    input clock;
    clock 							:in std_logic;
	top 							:in std_logic(9 to 0);
	prescaler 						:in std_logic(31 to 0);
	count_2_reach_2_top 			:in std_logic(9 to 0);
...
architecture IMP of uart_peripheral is
  ...
  component user_logic is
    ...
    (
      -- ADD USER PORTS BELOW THIS LINE ------------------
          clock 							:in std_logic;
		top 							:in std_logic(0 to 9);
		prescaler 						:in std_logic(0 to 31);
		count_2_reach_2_top 			:in std_logic(0 to 9);
		pwm_out 						:out std_logic;
	  -- ADD USER PORTS ABOVE THIS LINE ------------------
