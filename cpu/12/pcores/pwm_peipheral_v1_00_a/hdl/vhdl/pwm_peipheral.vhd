------------------------------------------------------------------------------
-- pwm_peipheral.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          pwm_peipheral.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Thu Jul 19 01:37:37 2018 (by Create and Import Peripheral Wizard)
...
entity pwm_peipheral is
  ...
  (
    ...
    clock 						:in std_logic;
	top 						:in std_logic_vector(9 to 0);
	prescaler 					:in std_logic_vector(31 to 0);	
	count_2_reach_2_top 		:in std_logic_vector(9 to 0);	
...
end entity pwm_peipheral;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of pwm_peipheral is
